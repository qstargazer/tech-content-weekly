...
class ReportTest(unittest.TestCase):
    ...
    def test_action_runs_tuesday_and_friday_0513_shanghai(self):
        workflow = (ROOT / ".github/workflows/weekly.yml").read_text(encoding="utf-8")
        self.assertIn('cron: "13 21 * * 1,4"', workflow)
        self.assertIn("Tuesday 05:13 and Friday 05:13 Asia/Shanghai", workflow)
